...
sprite5 = Sprite.new
sprite5.bitmap = Bitmap.new("Graphics/test")
bitmap =  Bitmap.new("Graphics/test2")
...
sprite5.y = 125
sprite6 = Sprite.new
sprite6.bitmap = Bitmap.new("Graphics/test3")
bitmap =  Bitmap.new("Graphics/test2")
...
# Flip and opacity
bitmap = Bitmap.new("Graphics/test6")
sprite7 = Sprite.new
...
sprite10 = Sprite.new
bitmap = Bitmap.new("Graphics/test")
...
bitmap.dispose
sprite11 = Sprite.new
sprite11.bitmap = Bitmap.new("Graphics/test2")
sprite11.opacity = 192
sprite11.x = 500
sprite11.y = 330
sprite11.zoom_x = sprite11.zoom_y = 8
sprite12 = Sprite.new
sprite12.bitmap = Bitmap.new("Graphics/test2")
sprite12.opacity = 192
sprite12.x = 500
sprite12.y = 330
sprite12.zoom_x = sprite12.zoom_y = 4
sprite13 = Sprite.new
sprite13.bitmap = Bitmap.new("Graphics/test2")
