...
public :
    ...
    void CopyA(const Image& Source, unsigned int DestX, unsigned int DestY, const IntRect& SourceRect, bool ApplyAlpha, int opacity);
    void HSL_Adjust(int h, double s, double l, const IntRect& DestRect);
    void FillRect(const IntRect& DestRect, const Color& Col);
    Image Resample(unsigned int Width, unsigned int Height, const IntRect& SourceRect);
    void DDrawText(int x, int y, int width, int height, const Unicode::Text& Text, const Color &Col);
